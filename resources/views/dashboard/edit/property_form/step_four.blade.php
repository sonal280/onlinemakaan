<div class="card-body" id="edit-form-step-4" style="display: none;">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <div class="form-group">
                  <label>Price:</label>
                  <input type="text" class="form-control" name="price" id="price" value="{{$property_data->price}}">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <textarea class="form-control" name="" id="description" cols="30" rows="10">{{$property_data->description}}</textarea>
