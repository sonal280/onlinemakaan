<section class="content" id="edit-form-step-6" style="display:none">
    ...
    @foreach ($property_images as $property_image)
        <div class="col-md-2" id="pro_image_{{$property_image->id}}">
            ...
            <a href="javascript:void(0)" onclick="remove(this, '<?php echo $property_image->id; ?>')" ><img src="{{ asset('storage/images/webicon/close.png')}}" 
        ...
        <div class="col-md-12">
            <div class="box box-primary ">
                <div class="box-header with-border">
                    <h4 class="box-title">Upload Property Image</h4>
                </div>
